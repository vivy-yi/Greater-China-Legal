...
```
内部材料 → legal-document-redaction（脱敏隐去当事人真实身份 + 比对文件）
         → 外发境外协办律师
         → 收回协办反馈
...
- **触发时机**：外部律师协办需共享案件材料时
- **输出用途**：协办材料版 / 共享版本
- **配置**：调用前 Read `legal-document-redaction/references/config.md`
- **特别注意**：境外律师适用 GDPR / 美国 privacy law，pseudonymisation 不脱 GDPR 适用范围（注意 § 4.6）
