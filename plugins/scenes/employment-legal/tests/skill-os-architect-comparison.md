...
# 在 Claude Code 中：
# 1. 备份当前 CLAUDE.md
cp plugins/scenes/employment-legal/CLAUDE.md /tmp/CLAUDE.md.scene-claudemd-curator

# 2. 切换到新 CLAUDE.md
cp plugins/scenes/employment-legal/CLAUDE.md.os-architect-design plugins/scenes/employment-legal/CLAUDE.md

# 测试结束后恢复
cp /tmp/CLAUDE.md.scene-claudemd-curator plugins/scenes/employment-legal/CLAUDE.md
```
