---
name: infringement-evidence-collection
description: |
  分析infringement-evidence-collection相关知识产权侵权问题。
  覆盖：侵权行为识别、证据收集、维权策略建议。
  适用情形：用户说"infringement-evidence-collection"相关问题。
argument-hint: "[核心事实]"
...
```
# infringement-evidence-collection — [简要描述]
