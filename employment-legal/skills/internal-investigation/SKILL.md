...
根据调查结果，如建议对员工作出纪律处分（包括解除劳动合同），须注意以下中国大陆法律要求：

**涉及工会会员的处理程序：**
- 用人单位单方解除劳动合同，应当事先将理由通知工会（劳动合同法第43条）
- 工会对解除有异议的，有权要求用人单位纠正
- 用人单位须研究工会意见，并将处理结果书面通知工会
- **未履行通知工会程序**可能导致解除被认定为违法（2N赔偿）

**职代会/职工代表程序（无工会的情况下）：**
- 解除涉及员工重大利益，建议经职工代表大会讨论
- 保留会议记录和职工代表签字

**特殊情况：**
- 被调查对象为工会主席/副主席：须先经上级工会批准（工会法第18条）
- 被调查对象为职工代表：解除前须经原选举单位罢免同意
- 涉及党员/人大代表/政协委员：建议同步与相关组织沟通

**劳动仲裁前置：**
- 解除劳动合同引发的争议，员工可申请劳动仲裁（一年时效）
- 仲裁委可能审查解除的程序合规性（包括通知工会）
- 建议保留完整的调查文件和程序记录

**刑事报案评估：**
- 如调查发现涉嫌犯罪线索（如职务侵占、商业贿赂），须评估是否向公安机关报案
- 报案前须确认：涉案金额/情节是否达到立案标准
- 一旦报案，劳动关系处理须配合刑事程序
- 劳动仲裁程序与刑事程序并行时的处理策略须由律师制定
